 ...
 * @param cwd
 * @param pkg
 * @returns eslint-config-polaris/index
 * @returns eslint-config-polaris/react
 * @returns eslint-config-polaris/typescript/index
 * @returns eslint-config-polaris/typescript/react
 */
