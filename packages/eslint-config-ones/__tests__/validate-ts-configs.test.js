/**
 * 验证 TS 规则，包括：
 * eslint-config-ones/typescript
 * eslint-config-ones/typescript/react
 * eslint-config-ones/typescript/vue
 */
...
describe('Validate TS configs', () => {
  it('Validate eslint-config-ones/typescript', async () => {
  ...
  it('Validate eslint-config-ones/typescript/react', async () => {
  ...
  it('Validate eslint-config-ones/typescript/vue', async () => {
  ...
  it('Validate eslint-config-ones/essential/typescript', async () => {
  ...
  it('Validate eslint-config-ones/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-ones/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-ones/typescript/node', async () => {
