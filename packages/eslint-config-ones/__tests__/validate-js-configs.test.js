 ...
 * 验证 JS 规则，包括：
 * eslint-config-ones
 * eslint-config-ones/es5
 * eslint-config-ones/react
 * eslint-config-ones/vue
 */
...
describe('Validate JS configs', () => {
  it('Validate eslint-config-ones', async () => {
  ...
  it('Validate eslint-config-ones/es5', async () => {
  ...
  it('Validate eslint-config-ones/react', async () => {
  ...
  it('Validate eslint-config-ones/vue', async () => {
  ...
  it('Validate eslint-config-ones/essential', async () => {
  ...
  it('Validate eslint-config-ones/essential/es5', async () => {
  ...
  it('Validate eslint-config-ones/essential/react', async () => {
  ...
  it('Validate eslint-config-ones/essential/vue', async () => {
    ...
    assert.equal(sumBy(results, 'fatalErrorCount'), 0)
    assert.notEqual(sumBy(results, 'errorCount'), 0)
    assert.equal(sumBy(results, 'warningCount'), 2)
  ...
  it('Validate eslint-config-ones/node', async () => {
